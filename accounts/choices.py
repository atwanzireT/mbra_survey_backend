...
"""
Central place for location choices used by the accounts app.
"""

# Top-level divisions in Mbarara City
DIVISION_CHOICES = (
    ("South_Division", "South Division"),
    ("North_Division", "North Division"),
)

# All wards (grouped by comment only for readability)
WARD_CHOICES = (
...
# All cells (flat list; grouping is only via comments)
CELL_CHOICES = (
    # Kakoba Ward cells
...
# Helper: which ward belongs to which division
WARD_TO_DIVISION = {
    # South Division wards
    "Kakoba Ward": "South_Division",
    "Nyamityobora Ward": "South_Division",
    "Katete Ward": "South_Division",
    "Ruti Ward": "South_Division",
    "Bugashe Ward": "South_Division",
    "Katojo Ward": "South_Division",

    # North Division wards
    "Rwenjeru Ward": "North_Division",
    "Nyabuhama Ward": "North_Division",
    "Biharwe East Ward": "North_Division",
    "Biharwe West Ward": "North_Division",
    "Kishasha Ward": "North_Division",
    "Kamukuzi Ward": "North_Division",
    "Ruharo Ward": "North_Division",
    "Kakiika Ward": "North_Division",
    "Rwemigina Ward": "North_Division",
}
